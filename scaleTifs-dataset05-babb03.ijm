...
macroName = "scaleTifs-dataset05-babb03.ijm";
print("-----------------------------------------------------------");
...
// dataset05: babb03 scaling factors (to arrive at voxel size of 2.53 x 2.53 x 10 (xyz))
xScaling = 0.395256917
yScaling = 0.395256917
zScaling = 0.1
